            ...
            <div id="area_paginas">
                <div id="escolha">
                    <div class="escolhaPagina">
                        ...
                        <div class="nomePagina"><a  class="link" href="admCuriosidades.php">Administração curiosidades</a></div>
                    </div>
                    <div class="escolhaPagina">
                        <img src="../imagens/store.png" />   
                        <div class="nomePagina"><a class="link" href="admLojas.php"> Administração das lojas</a></div>
                    </div>
                    <div class="escolhaPagina">
                        <img src="../imagens/sobre.png" />   
                        <div class="nomePagina"><a class="link" href="admSobre.php"> Administração da pagina Sobre</a></div>
                    </div>
                </div>
            </div>
