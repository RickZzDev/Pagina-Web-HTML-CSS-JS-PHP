...
/*Chamando a função*/
require_once('MODULOS/funcCalc.php');
...
const DIV_ZERO = "Não existe divisão por zero";
        ...
        <div id="linhaSup">
            ...
            <div id="calc_caixa">
                ...
                <div id="caixa_inferior">
                    <form name="frmCalc" method="post" action="Calculadora.php">
                    <div id="linha_sup">
                        <div id="numeros">
